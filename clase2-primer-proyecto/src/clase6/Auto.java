...
public class Auto {
	...
	//Persona( que tiene? = atributos(variables) y que hace? = metodos (funciones). 
	//Lo que lo hace una clase. Que luego lo convierte en un objeto
	...
	//metodos = funciones
	//los metodos por lo general modifican la/s variables dentro de la clase
	void encender() {
		if(!encendido) {
			encendido = true;
